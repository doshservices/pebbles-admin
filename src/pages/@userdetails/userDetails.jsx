...
import amenity from './assets/amenity-img.png';
import savedImg from './assets/saved-img.png';
import starsImg from './assets/stars.png';
import heartImg from './assets/blue-heart.svg';
    ...
    <>
      ...
      <section className="user-details">
        ...
        <section className="user-details-info">
            ...
            <div className="user-details-profile">
              ...
              <div>
                ...
                <div className="contact">
                  <div> <span className="circle-indicator"></span>
                    {
          ...
          <div className="current-and-saved">
            <div className="current-booking-div">
              ...
              <div className="apartment-amenities">
                ...
                <div>
                  <p>
                    24hrs Power Supply, Fast Wi-Fi, LED TV, AC,Heater, Gym, Pool, Kitchen, Pet-friendly.24hrs Power Supply, Fast Wi-Fi, LED TV, AC,Heater, Gym, Pool, Kitchen, Pet-friendly.
                  </p>
                </div>
              </div>
              <div className="amenities-images">
                <div>
                  <img src={amenity} alt="A furnished room" />
                </div>
                <div>
                  <img src={amenity} alt="A furnished room" />
                </div>
            ...
            <div className="saved-listings-div">
              <div>
                <h3>Saved Listings</h3>
              </div>
              <div className="saved-listings-items">
                <div className="saved-listings-item">
                  <div>
                    <div className="previous-arrow-div">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M7.62317 10.0626L12.3086 14.748L13.1481 13.9086L9.2826 10.0626L13.1285 6.21667L12.2891 5.37719L7.62317 10.0626Z" fill="#2D2D2D"/>
                      </svg>
                    </div>
                    <div>
                      <img src={savedImg} alt="A furnished room" />
                    </div>
                    <div className="next-arrow-div">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M12.6495 10.0626L7.96411 14.748L7.12463 13.9086L10.9901 10.0626L7.14416 6.21667L7.98363 5.37719L12.6495 10.0626Z" fill="#2D2D2D"/>
                      </svg>
                    </div>
                  </div>
                  <div className="saved-listings-item-details">
                      <div>
                        <h5>Surulere Lagos, Nigeria</h5>
                        <div>
                      ...
                      <div>
                        <p>5 Bedroom Apartment</p>
                      </div>
                      <div>
                        <div className="pricing">
                          <div>
                            <span className="price"><s className="currency">N</s>12,000 </span> <span className="rate"> avg/night</span>
                          </div>
                        </div>
                        <div>
                          <img src={heartImg} alt="Blue heart" />
                        </div>
                      </div>
                  </div>
                </div>
              ...
              <div className="view-more-div">
                <div>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" fill="none">
                    <path d="M6 7.5L0 1.5636L1.075 0.5L6 5.39753L10.925 0.524735L12 1.58834L6 7.5Z" fill="#155EEF"/>
                  </svg>
                </div>
              </div>
            </div>
